        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    {{-- membuat menu berupa link menuju halaman home --}}
                    ...
                    {{-- namum karena route dan controller untuk employee belum dibuat maka belum bisa digunakan, sehingga bagian ini harus di hapus atau coment agar halaman web tidak error  --}}
                ...
                {{-- namum karena route dan controller untuk My Profile belum dibuat maka belum bisa digunakan, sehingga bagian ini harus di hapus atau coment agar halaman web tidak error --}}
